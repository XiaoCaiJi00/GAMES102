...
struct CanvasSystem {
  ...
  static void parameterization(const std::vector<Ubpa::pointf2>& input, std::vector<double>& tParam, int type);
  static void uniformParameterization(const std::vector<Ubpa::pointf2>& input, std::vector<double>& tParam);
  static void chordLengthParameterization(const std::vector<Ubpa::pointf2>& input, std::vector<double>& tParam);
  static void centripetalParameterization(const std::vector<Ubpa::pointf2>& input, std::vector<double>& tParam);
